...
class Ui_PodContainerWidget(object):
    def setupUi(self, PodContainerWidget):
        ...
        self.btn_follow_logs = QtWidgets.QToolButton(PodContainerWidget)
        self.btn_follow_logs.setObjectName("btn_follow_logs")
        self.horizontalLayout_2.addWidget(self.btn_follow_logs)
    ...
    def retranslateUi(self, PodContainerWidget):
        ...
        self.btn_follow_logs.setText(_translate("PodContainerWidget", "Follow Logs"))
