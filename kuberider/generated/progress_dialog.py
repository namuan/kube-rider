...
class Ui_ProgressDialog(object):
    def setupUi(self, ProgressDialog):
        ...
        self.lbl_progress_status.setGeometry(QtCore.QRect(30, 30, 581, 16))
        ...
        self.btn_cancel_progress.setGeometry(QtCore.QRect(270, 70, 113, 32))
